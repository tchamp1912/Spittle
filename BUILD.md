...
This guide covers how to set up the development environment and build Spittle from source across different platforms.
...
```bash
git clone git@github.com:cjpais/Spittle.git
cd Spittle
```
