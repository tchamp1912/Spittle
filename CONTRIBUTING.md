# Contributing to Spittle

Thank you for your interest in contributing to Spittle! This guide will help you get started with contributing to this open source speech-to-text application.

**Note:** Spittle is a fork of [Spittle](https://github.com/cjpais/Spittle) by CJ Pais. We maintain the same philosophy and open-source principles.

## 📖 Philosophy

Spittle aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Spittle.git
   cd Spittle
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:tchamp1912/Spittle.git
   ```
...
5. **Download required models**:
   ...
   curl -o src-tauri/resources/models/silero_vad_v4.onnx https://blob.spittle.computer/silero_vad_v4.onnx
   ```
...
Spittle follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/tchamp1912/Spittle/issues](https://github.com/tchamp1912/Spittle/issues)
2. **Check discussions** at [github.com/tchamp1912/Spittle/discussions](https://github.com/tchamp1912/Spittle/discussions)
...
1. **Search existing discussions** at [github.com/tchamp1912/Spittle/discussions](https://github.com/tchamp1912/Spittle/discussions)
2. **Check discussions** for existing feature requests

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/tchamp1912/Spittle/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Spittle's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/tchamp1912/Spittle/issues)
   - [Closed issues](https://github.com/tchamp1912/Spittle/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/tchamp1912/Spittle/pulls)
   - [Closed PRs](https://github.com/tchamp1912/Spittle/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/tchamp1912/Spittle/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Spittle stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Spittle the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [Spittle repository](https://github.com/tchamp1912/Spittle)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/tchamp1912/Spittle/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/tchamp1912/Spittle/discussions)
- **Issues**: Report bugs or request features on [GitHub Issues](https://github.com/tchamp1912/Spittle/issues)

## 📜 License

By contributing to Spittle, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Spittle!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
