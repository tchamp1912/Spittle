{
  description = "Spittle - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          spittle = pkgs.rustPlatform.buildRustPackage {
            pname = "spittle";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/tchamp1912/Spittle";
          ...
          default = self.packages.${system}.spittle;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Spittle development environment"
              bun install
